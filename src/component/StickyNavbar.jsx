...
const StickyNavbar = () => {
  ...
  return (
    ...
    {isSticky ? (
        <>
            <img src={logoFilled} alt='logo' className='w-6 h-6 opacity-100'></img>
            ...
            <div className='justify-between items-center flex md:hidden'>
                <ul className='flex gap-1 py-2 text-dgray transition-all'>
                    ...
                    <span className="hidden group-hover:inline transition-all duration-300">Home</span>
                    </li>
                    <li
                    onClick={() => scrollToSection('skills')}
                    className='group border px-3 rounded-[1.5rem] flex gap-1 items-center cursor-pointer hover:bg-dgray hover:border-dgray hover:text-white transition ease-in-out duration-300'
                    ...
                    <span className="hidden group-hover:inline transition-all duration-300">Skills</span>
                    </li>
                    <li
                    onClick={() => scrollToSection('contact')}
                    className='group border px-3 rounded-[1.5rem] flex gap-1 items-center cursor-pointer hover:bg-dgray hover:border-dgray hover:text-white transition ease-in-out duration-300'
                    ...
                    <span className="hidden group-hover:inline transition-all duration-300">Contact</span>
                    </li>
                    <li
                    onClick={() => scrollToSection('projects')}
                    className='group border px-3 rounded-[1.5rem] flex gap-1 items-center cursor-pointer hover:bg-dgray hover:border-dgray hover:text-white transition ease-in-out duration-300'
                    ...
                    <span className="hidden group-hover:inline transition-all duration-300">Projects</span>
                    </li>
                </ul>
            </div>
        ...
        <div className='flex gap-2 items-center justify-center'>
            <img src={logoFilled} alt='logo filled' className='w-6 h-6 opacity-100'></img>
            <h1 className='font-bold text-gray'>Marbls<span className='text-dgray text-xl'>Lats</span></h1>
        </div>
    )}
  </div>
</div>
